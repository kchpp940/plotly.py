...
docs = dict(
    ...
    field_display=[
        "dict with str keys and str or bool values (default `{}`)",
        ...
        "  1. **Column names**: Original or internal column names (e.g. `\"sales\"`, `\"value\"`, `\"variable\"`)",
        "  2. **Semantic roles**: `\"x\"`, `\"y\"`, `\"color\"`, `\"size\"`, `\"symbol\"`, `\"line_dash\"`,",
        "     `\"pattern_shape\"`, `\"facet_row\"`, `\"facet_col\"`, `\"animation_frame\"`, `\"line_group\"`, `\"hover_name\"`",
        "  3. **Derived/internal names**: `\"value\"`, `\"variable\"`, `\"index\"` (used in wide-form conversions)",
        "",
        "Values can be:",
        "  - A string: the display name for the field",
        "  - `False`: hide the field from hover tooltips",
        "  - `True` or any other truthy value: show the field with its default name",
        "",
        "When both `labels` and `field_display` are provided, `field_display` takes precedence.",
        "For wide-form data, use `\"value\"` and `\"variable\"` keys to control the display names",
        "of the melted value and variable columns respectively.",
    ],
    category_orders=[
